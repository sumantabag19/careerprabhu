...
var lifecoachactivitymanager = /** @class */ (function () {
    function lifecoachactivitymanager(http, router, localstorage, toaster, loader) {
        this.http = http;
        this.router = router;
    ...
    lifecoachactivitymanager.prototype.ngOnInit = function () {
        this.BindCoachType();
        this.BindInterviewData();
        this.BindJourneyData();
        this.BindArticleData();
    };
    lifecoachactivitymanager.prototype.GetIntDetail = function (event) {
        debugger;
    ...
    lifecoachactivitymanager.prototype.GetjourneyDetail = function (event) {
        debugger;
    ...
    lifecoachactivitymanager.prototype.GetarticleDetail = function (event) {
        debugger;
    ...
    lifecoachactivitymanager.prototype.BindCoachType = function () {
        var _this = this;
    ...
    lifecoachactivitymanager.prototype.BindCoach = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
    ...
    //save interview data
    lifecoachactivitymanager.prototype.InterviewSave = function () {
        var _this = this;
        if (this.ButtonInterviewsText == "Save") {
            ...
            input.append("subtitle", this.intsubtitle.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/lifecoachactivity/updateinterviewdata', input)
                .subscribe(function (data) {
                debugger;
                _this.interviewdata = data;
                if (_this.interviewdata.length > 10) {
    ...
    lifecoachactivitymanager.prototype.BindInterviewData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.Details = [];
        this.http.get('api/lifecoachactivity/Bindtabledata', options).subscribe(function (data) {
            debugger;
            _this.Details = data;
            _this.GetSaveData = _this.Details.data;
        });
    };
    lifecoachactivitymanager.prototype.EditInterview = function (i, Id) {
        var _this = this;
        debugger;
        this.ButtonInterviewsText = 'Update';
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoachactivity/GetEditInterviewData?lifeinterviewid=' + Id, options).subscribe(function (data) {
            debugger;
            ...
            if (_this.EditInterviewData.Status == true) {
                ...
                _this.inturl = _this.EditInterviewData.data.videourl;
                _this.lifeinterviewid = _this.EditInterviewData.data.lifeinterviewid;
            }
        });
    };
    lifecoachactivitymanager.prototype.DeleteInterview = function (i, Id) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/lifecoachactivity/Deleteinterviewdata', body, options).subscribe(function (data) {
    ...
    lifecoachactivitymanager.prototype.onClearInterviews = function () {
        this.selectedtopic = 0;
        this.selectedcoach = 0;
        this.inttitle = "";
        this.intsubtitle = "";
    ...
    lifecoachactivitymanager.prototype.journeySave = function () {
        var _this = this;
        if (this.ButtonjourneyText == "Save") {
            ...
            input.append("videourl", this.jouurl.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/lifecoachactivity/savejourneydata', input)
                .subscribe(function (data) {
                debugger;
            ...
            input.append("videourl", this.jouurl.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/lifecoachactivity/updatejourneydata', input)
                .subscribe(function (data) {
                debugger;
                _this.journeydata = data;
                if (_this.journeydata.length > 10) {
    ...
    lifecoachactivitymanager.prototype.BindJourneyData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoachactivity/Bindjourneytabledata', options).subscribe(function (data) {
            debugger;
            _this.journeydetails = data;
            _this.GetSaveJourneyData = _this.journeydetails.data;
        });
    };
    lifecoachactivitymanager.prototype.EditJourney = function (i, Id) {
        var _this = this;
        debugger;
        this.ButtonjourneyText = 'Update';
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoachactivity/GetEditjourneyData?journeyid=' + Id, options).subscribe(function (data) {
            debugger;
            ...
            if (_this.EditJourneyData.Status == true) {
                ...
                _this.jouurl = _this.EditJourneyData.data.videourl;
                _this.journeyid = _this.EditJourneyData.data.journeyid;
            }
        });
    };
    lifecoachactivitymanager.prototype.DeleteJourney = function (i, Id) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/lifecoachactivity/Deletejourneydata', body, options).subscribe(function (data) {
    ...
    lifecoachactivitymanager.prototype.onClearJOurney = function () {
        this.selectedtopic = 0;
        this.selectedcoach = 0;
        this.journeytitle = "";
        this.jousubtitle = "";
    ...
    lifecoachactivitymanager.prototype.articleSave = function () {
        var _this = this;
        if (this.ButtonarticleText == "Save") {
            ...
            input.append("videourl", this.arturl.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/lifecoachactivity/savearticledata', input)
                .subscribe(function (data) {
                debugger;
            ...
            input.append("videourl", this.arturl.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/lifecoachactivity/updatearticledata', input)
                .subscribe(function (data) {
                debugger;
                _this.articledata = data;
                if (_this.articledata.length > 10) {
    ...
    lifecoachactivitymanager.prototype.onClearArticle = function () {
        this.selectedtopic = 0;
        this.selectedcoach = 0;
        this.articletitle = "";
        this.articlesubtitle = "";
    ...
    lifecoachactivitymanager.prototype.BindArticleData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoachactivity/BindArticletabledata', options).subscribe(function (data) {
            debugger;
            _this.Articledetails = data;
            _this.GetSaveArticleData = _this.Articledetails.data;
        });
    };
    lifecoachactivitymanager.prototype.EditArticle = function (i, Id) {
        var _this = this;
        debugger;
        this.ButtonarticleText = 'Update';
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoachactivity/GetEditArticleidData?articleid=' + Id, options).subscribe(function (data) {
            debugger;
    ...
    lifecoachactivitymanager.prototype.DeleteArticle = function (i, Id) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/lifecoachactivity/DeleteArticledata', body, options).subscribe(function (data) {
    ...
    ], lifecoachactivitymanager.prototype, "myintfileVariabl", void 0);
    __decorate([
        core_1.ViewChild('journeyfile', { static: true }),
        __metadata("design:type", core_1.ElementRef)
    ], lifecoachactivitymanager.prototype, "myintfileVariabl1", void 0);
    __decorate([
        core_1.ViewChild('articlefile', { static: true }),
        __metadata("design:type", core_1.ElementRef)
    ], lifecoachactivitymanager.prototype, "myintfileVariabl2", void 0);
    lifecoachactivitymanager = __decorate([
        core_1.Component({
            selector: 'app-lifecoachesactivity',
            templateUrl: './lifecoachactivity.component.html'
        }),
    ...
    ], lifecoachactivitymanager);
    return lifecoachactivitymanager;
}());
exports.lifecoachactivitymanager = lifecoachactivitymanager;
//# sourceMappingURL=lifecoachactivity.component.js.map