...
export class lifecoachactivitymanager implements OnInit {
  inturl: string = "";
  jouurl: string = "";
  arturl: string = "";
  ...
  EditInterview(i: number, Id) {
    ...
    this.http.get('api/lifecoachactivity/GetEditInterviewData?lifeinterviewid=' + Id, options).subscribe(
      (data) => {
        debugger;
        ...
        if (this.EditInterviewData.Status == true) {
          ...
          this.inturl = this.EditInterviewData.data.videourl;
  ...
  DeleteInterview(i: number, Id) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.http.post('api/lifecoachactivity/Deleteinterviewdata', body, options).subscribe(
          (data) => {
  ...
  EditJourney(i: number, Id) {
    ...
    this.http.get('api/lifecoachactivity/GetEditjourneyData?journeyid=' + Id, options).subscribe(
      (data) => {
        debugger;
        ...
        if (this.EditJourneyData.Status == true) {
          ...
          this.jouurl = this.EditJourneyData.data.videourl;
  ...
  DeleteJourney(i: number, Id) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.http.post('api/lifecoachactivity/Deletejourneydata', body, options).subscribe(
          (data) => {
  ...
  EditArticle(i: number, Id) {
    ...
    this.http.get('api/lifecoachactivity/GetEditArticleidData?articleid=' + Id, options).subscribe(
      (data) => {
        debugger;
  ...
  DeleteArticle(i: number, Id) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.http.post('api/lifecoachactivity/DeleteArticledata', body, options).subscribe(
          (data) => {
