...
var productusagemanager = /** @class */ (function () {
    function productusagemanager(http, router, localstorage, toaster, loader) {
        this.http = http;
        this.router = router;
    ...
    productusagemanager.prototype.ngOnInit = function () {
        this.getPage();
        this.Binddata();
        this.getLanguage();
    };
    //bind topic
    productusagemanager.prototype.getPage = function () {
        var _this = this;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        var a;
        var tmpclass = [];
        this.http.get('api/productusage/bindpage', options).subscribe(function (data) {
            debugger;
    ...
    productusagemanager.prototype.getLanguage = function () {
        var _this = this;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        var a;
        var tmpclass = [];
        this.http.get('api/productusage/bindlanguage', options).subscribe(function (data) {
            debugger;
    ...
    //get pdf details
    productusagemanager.prototype.GetPdfDetail = function (event) {
        debugger;
        this.pdffile = event;
    ...
    //save life coaches
    productusagemanager.prototype.onSave = function () {
        var _this = this;
        debugger;
        if (this.ButtonText == "Save") {
            ...
            this.http.post('api/productusage/saveportfoliodata', input)
            ...
            input.append("languageid", this.selectedlanguage.toString());
            input.append("createdby", this.localstorage.get("userid").toString());
            this.http.post('api/productusage/updateportfoliodata', input)
                .subscribe(function (data) {
                _this.UploadData = data;
                if (_this.UploadData.Status == true) {
                    if (_this.UploadData.Message == "Video/PDF already exists") {
    ...
    //bind table data
    productusagemanager.prototype.Binddata = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.Details = [];
        this.http.get('api/productusage/Bindtabledata', options).subscribe(function (data) {
            debugger;
            _this.Details = data;
            _this.GetSaveData = _this.Details.data;
        });
    };
    productusagemanager.prototype.onClear = function () {
        this.selectedpage = 0;
        this.selectedlanguage = 0;
        this.ButtonText = "Save";
        this.videolink = "";
    ...
    //edit record
    productusagemanager.prototype.EditData = function (i, vid_pdfid) {
        var _this = this;
        debugger;
        this.ButtonText = 'Update';
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/productusage/GetEditData?vid_pdfid=' + vid_pdfid, options).subscribe(function (data) {
            debugger;
    ...
    //delete record
    productusagemanager.prototype.DeleteData = function (i, vid_pdfid) {
        var _this = this;
        debugger;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/productusage/DeleteActivity', body, options).subscribe(function (data) {
    ...
    ], productusagemanager.prototype, "myInputVariabl", void 0);
    productusagemanager = __decorate([
        core_1.Component({
            selector: 'app-productusage',
    ...
    return productusagemanager;
}());
exports.productusagemanager = productusagemanager;
//# sourceMappingURL=productusage.component.js.map