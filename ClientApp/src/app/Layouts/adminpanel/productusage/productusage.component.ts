...
export class productusagemanager implements OnInit {
  ...
  getPage() {
    ...
    var a;
    var tmpclass: any = [];
    this.http.get('api/productusage/bindpage', options).subscribe(
      (data) => {
        debugger;
  ...
  getLanguage() {
    ...
    var a;
    var tmpclass: any = [];
    this.http.get('api/productusage/bindlanguage', options).subscribe(
      (data) => {
        debugger;
  ...
  Binddata() {
    ...
    this.http.get('api/productusage/Bindtabledata', options).subscribe(
      (data) => {
        debugger;
        this.Details = data;
  ...
  EditData(i: number, vid_pdfid) {
    ...
    this.http.get('api/productusage/GetEditData?vid_pdfid=' + vid_pdfid, options).subscribe(
      (data) => {
        debugger;
  ...
  DeleteData(i: number, vid_pdfid) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.http.post('api/productusage/DeleteActivity', body, options).subscribe(
          (data) => {
