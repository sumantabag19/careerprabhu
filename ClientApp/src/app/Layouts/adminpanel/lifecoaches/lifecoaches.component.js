...
var lifecoachesmanager = /** @class */ (function () {
    function lifecoachesmanager(http, router, localstorage, toaster, loader) {
        this.http = http;
        this.router = router;
    ...
    lifecoachesmanager.prototype.ngOnInit = function () {
        this.getTopic();
        this.getCareer();
        this.BindInterviewData();
    };
    //bind topic
    lifecoachesmanager.prototype.getTopic = function () {
        var _this = this;
        ...
        var a;
        var tmpclass = [];
        this.http.get('api/lifecoaches/BindTopic', options).subscribe(function (data) {
            _this.TopicDetails = data;
            _this.TopicData = _this.TopicDetails;
        });
    };
    //bind career
    lifecoachesmanager.prototype.getCareer = function () {
        var _this = this;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.TopicDetails = [];
        var a;
        var tmpclass = [];
        this.http.get('api/lifecoaches/BindCareer', options).subscribe(function (data) {
            _this.CareerDetails = data;
            _this.careerdata = _this.CareerDetails;
            _this.BindInterviewData();
        });
    };
    lifecoachesmanager.prototype.SelectAllCareer = function () {
        debugger;
        this.careerid = "";
    ...
    lifecoachesmanager.prototype.getSelectedCareer = function () {
        debugger;
        this.careerid = "";
        var count = 0;
        for (var i = 0; i < this.careerdata.length; i++) {
    ...
    //get pdf details
    lifecoachesmanager.prototype.GetPhotoDetail = function (event) {
        debugger;
        this.pdffile = event;
    ...
    lifecoachesmanager.prototype.GetIntDetail = function (event) {
        debugger;
    ...
    //save life coaches
    lifecoachesmanager.prototype.InterviewSave = function () {
        var _this = this;
        debugger;
        if (this.ButtonInterviewsText == "Save") {
            ...
            this.http.post('api/lifecoaches/savelifecoachesdata', input)
                ...
                if (_this.lifecoachesdata.length > 10) {
    ...
    //bind table data
    lifecoachesmanager.prototype.BindInterviewData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.Details = [];
        this.http.get('api/lifecoaches/BindInterviewData', options).subscribe(function (data) {
            debugger;
            _this.Details = data;
    ...
    //Edit interview data
    lifecoachesmanager.prototype.EditInterview = function (i, Id) {
        var _this = this;
        debugger;
        this.getCareer();
        this.getTopic();
        ...
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/lifecoaches/GetEditData?interviewid=' + Id, options).subscribe(function (data) {
            debugger;
            ...
            if (_this.GetEditedData.Status == true) {
                ...
                _this.selectedtopic = _this.EditLifeInterviewData.data.coachtypeid;
    ...
    lifecoachesmanager.prototype.onClearInterviews = function () {
        this.selectedtopic = 0;
        this.selectedcareer = 0;
        this.coachname = "";
        this.fbid = "";
    ...
    //delete record
    lifecoachesmanager.prototype.DeleteInterview = function (i, Id) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/lifecoaches/DeleteActivity', body, options).subscribe(function (data) {
    ...
    ], lifecoachesmanager.prototype, "myInputVariabl", void 0);
    __decorate([
        core_1.ViewChild('intfile', { static: true }),
        __metadata("design:type", core_1.ElementRef)
    ], lifecoachesmanager.prototype, "myintfileVariabl", void 0);
    lifecoachesmanager = __decorate([
        core_1.Component({
    ...
    return lifecoachesmanager;
}());
exports.lifecoachesmanager = lifecoachesmanager;
//# sourceMappingURL=lifecoaches.component.js.map