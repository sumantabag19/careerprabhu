...
export class ProductManager implements OnInit {
      ...
      this.http.post('api/premiumproduct/SaveSopPropData', input)
        .subscribe(
          (data) => {
            ...
            if (this.soppropdata.Status ==true) {

              if (this.soppropdata.Message == "Product Already Exists") {
                Swal.fire("", "Poroduct Already Exists", "success");
                this.onClear();
                this.GetSavedData();
                return;
              }
  ...
  GetSavedData() {
    ...
    this.http.get('api/premiumproduct/BindSOPPropData', options).subscribe(
  ...
  EditData(i: number, soppropid) {
    ...
    let headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    let options = { headers: headers };
    this.http.get('api/premiumproduct/EditSopProp?soppropid=' + soppropid, options).subscribe(
  ...
  DeleteData(i: number, soppropid) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.http.post('api/premiumproduct/DeleteSopProp', body, options).subscribe(
          (data) => {
