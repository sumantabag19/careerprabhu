...
var countrymaster = /** @class */ (function () {
    function countrymaster(http, router, localstorage, toaster, loader, renderer, config, config1) {
        this.http = http;
        this.router = router;
    ...
    countrymaster.prototype.ngOnInit = function () {
        this.GetData();
    };
    countrymaster.prototype.GetData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.Detail = [];
        this.http.get('api/citymaster/GetSavedCountryData', options).subscribe(function (data) {
            debugger;
            _this.Detail = data;
            _this.GetSaveData = _this.Detail.data;
        });
    };
    countrymaster.prototype.onSubmit = function (i, Id) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/citymaster/Inactivecountry', body, options).subscribe(function (data) {
