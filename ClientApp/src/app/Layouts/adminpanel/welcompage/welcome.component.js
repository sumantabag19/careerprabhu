...
var WelcomeManager = /** @class */ (function () {
    function WelcomeManager(http, router, localstorage, toaster, loader) {
        this.http = http;
        this.router = router;
    ...
    WelcomeManager.prototype.ngOnInit = function () {
    };
    WelcomeManager = __decorate([
        core_1.Component({
