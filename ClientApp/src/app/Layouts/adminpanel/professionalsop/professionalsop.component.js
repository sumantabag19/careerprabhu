...
var professionalSOPManager = /** @class */ (function () {
    function professionalSOPManager(http, router, localstorage, toaster, loader) {
        this.http = http;
        this.router = router;
    ...
    professionalSOPManager.prototype.ngOnInit = function () {
        this.GetSavedData();
    };
    professionalSOPManager.prototype.GetImageDetail = function (event) {
        debugger;
    ...
    professionalSOPManager.prototype.onSave = function () {
        var _this = this;
        debugger;
        if (this.ButtonText == "Save") {
            ...
            this.http.post('api/SopHelpmaster/SaveSopPropData', input)
                ...
                if (_this.soppropdata.length > 10) {
    ...
    professionalSOPManager.prototype.GetSavedData = function () {
        var _this = this;
        debugger;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/SopHelpmaster/BindSOPPropData', options).subscribe(function (data) {
            debugger;
    ...
    professionalSOPManager.prototype.onClear = function () {
        this.testimonial = "";
        this.ButtonText = "Save";
        this.imagefile = [];
        this.imagetoupload = [];
    ...
    professionalSOPManager.prototype.EditData = function (i, soppropid) {
        var _this = this;
        debugger;
        this.ButtonText = 'Update';
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        this.http.get('api/SopHelpmaster/EditSopProp?soppropid=' + soppropid, options).subscribe(function (data) {
            debugger;
    ...
    professionalSOPManager.prototype.DeleteData = function (i, soppropid) {
        var _this = this;
        var data;
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        var options = { headers: headers };
        ...
        sweetalert2_1.default.fire({
            ...
            if (result.value) {
                _this.http.post('api/SopHelpmaster/DeleteSopProp', body, options).subscribe(function (data) {
    ...
    ], professionalSOPManager.prototype, "myInputVariableprefile", void 0);
    professionalSOPManager = __decorate([
        core_1.Component({
    ...
    ], professionalSOPManager);
    return professionalSOPManager;
}());
exports.professionalSOPManager = professionalSOPManager;
//# sourceMappingURL=professionalsop.component.js.map