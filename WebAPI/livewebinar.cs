...
{
    [Route("api/LiveWebinar")]
    public class livewebinar : Controller
    {
        ...
        string imageguid = "";
        public livewebinar(IConfiguration iconfiguration, IHostingEnvironment hosting)
        {
        ...
        public string GetSavedDataFilter([FromHeader] GetType obj)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("TopicManager_GetTopicFilter_update", con);
        ...
        public string GetTopic([FromHeader] GetType data)
        {
            ...
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("TopicManager_GetTopic_update", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string SavePlannedActivityData([FromBody] ActivityManagerParam obj)
        {
            ...
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("ActivityManager_update", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        [FromForm] string acttype, [FromForm] string topicid, [FromForm] string stateid, [FromForm] string cityid, [FromForm] string schoolid, [FromForm] string classid, [FromForm] string streamid, [FromForm] string studentid,
        ...
        //public string SavePlannedActivities([FromBody] ActivityManagerParam obj)
        {
            ...
            string[] studentlist = new string[50];
            ...
            {
                studentlist = studentid.Split(spearator,
               StringSplitOptions.RemoveEmptyEntries);
            }
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("stateid_d", (stateid == "0" || stateid == null) ? "0" : stateid);
                cmd.Parameters.AddWithValue("cityid_d", (cityid == "0" || cityid==null) ? "0" : cityid);
                cmd.Parameters.AddWithValue("schoolid_d", (schoolid == "0" || schoolid==null) ? "0" : schoolid);
                cmd.Parameters.AddWithValue("studentid_d", (studentid == "0" || studentid==null) ? "0" : studentid);
                ...
                if (result == "Successfully Saved" || result == "Successfully Updated")
                {
                    ...
                    if(objAmp.acttype == "Save")
                    {
                        ...
                        if (studentid != "0")
                        {
                            if (studentid != null && studentlist.Length > 0)
                            {
                                if (studentid.Length > 0)
                                {
                                    Execqry("delete from tbl_plannedstudent where activityid=" + maxid);
                                    for (int i = 0; i < studentlist.Length; i++)
                                    {

                                        Execqry("insert into tbl_plannedstudent(activityid,studentid)values(" + maxid + ", " + Convert.ToInt32(studentlist[i]) + ")");
                                    }
                    ...
                    if(objAmp.acttype == "Update")
                    {
                        if (stateid != "0" && stateid != null && objAmp.acttype == "Update")
                        {
                            if (stateid != null && stateid.Length > 0)
                            {
                                if (statelist.Length > 0)
                        ...
                        if (cityid != "0" && cityid != null && objAmp.acttype == "Update")
                        {
                            if (cityid != null && cityid.Length > 0)
                            {
                                if (citylist.Length > 0)
                        ...
                        if (schoolid != "0" && schoolid != null  && objAmp.acttype == "Update")
                        {
                            if (schoolid != null && schoolid.Length > 0)
                            {
                                if (schoollist.Length > 0)
                        ...
                        if (studentid != "0" && studentid != null && objAmp.acttype == "Update")
                        {
                            if (studentid != null && studentlist.Length > 0)
                            {
                                if (studentid.Length > 0)
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in ds.Tables[0].Rows)
                    {
                        ...
                        ObjGSTD.city = Convert.ToString(row["city"]);
                        ObjGSTD.school = Convert.ToString(row["school"]);
                        ObjGSTD.student = Convert.ToString(row["student"]);
        ...
        public string GetEditedData([FromHeader] GetType obj)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ObjGED.studentid = Convert.ToString(ds.Tables[0].Rows[0]["studentid"]);
        ...
        {
            public int stu_portal_id { get; set; } = 0;
