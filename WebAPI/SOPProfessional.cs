...
{
    [Route("api/SopHelpmaster")]
    public class SOPProfessional : Controller
    {
        ...
        public SOPProfessional(IConfiguration iconfiguration, IHostingEnvironment hosting)
        {
       ...
       [FromForm] string testimonial, [FromForm] string orgimagename, [FromForm] string createdby)

        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("SaveSOPPropData", con);
        ...
        public string EditSopProp([FromHeader] EditSopPropData data)
        {
            ...
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("EditSopProp", con);
                cmd.CommandType = CommandType.StoredProcedure;
       ...
       [FromForm] string testimonial, [FromForm] string orgimagename, [FromForm] string createdby)

        {
            ...
            try
            {
                ...
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("updatesopprop", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("message", "");
                cmd.Parameters["message"].Direction = ParameterDirection.Output;
    ...
    //Save professionalseek master sop
    public class SOPProfResponse
    {
        public bool Status { get; set; }
        public string Message { get; set; }
    }
    public class SampleProfParam
    {

        public Int32 soppropid { get; set; } = 0;
    ...
    public class GetSOPProfResponse
    {
        public bool Statue { get; set; }
        public string Message { get; set; }

        public List<GetSOPPropData> data { get; set; }

    }
    public class GetSOPPropData
    {
        public Int32 soppropid { get; set; } = 0;
    ...
    //class for edit data
    public class EditSopPropData
    {
        public int soppropid { get; set; }
    }
    public class EditSopPropResponse
    {
        public bool Status { get; set; } = false;
        public string Message { get; set; } = "";
        public List<SopPropEditData> data { get; set; }
    }
    public class SopPropEditData
    {
        public int soppropid { get; set; }
        public string testimonial { get; set; }
       public string testimonialname { get; set; }
    ...
    public class DeleteSampleSopaParam
    {
        public bool Status { get; set; } = false;
        public string Message { get; set; } = "";
        public Int32 soppropid { get; set; }
    }
}
