...
{
    [Route("api/lifecoachinformation")]
    public class lifecoachinformation : Controller
    {
        ...
        string photoguid = "";
        string pdfguid = "";
        public lifecoachinformation(IConfiguration iconfiguration, IHostingEnvironment hosting)
        {
        ...
        public string BindAgenda()
        {
            ...
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("Bindagenda", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<IActionResult> Savelifecoachesdata([FromForm] IFormFile photo, [FromForm] string coachtype, [FromForm] string agendatype,
            [FromForm] string topic,[FromForm] string coachname, [FromForm] string mobileno, [FromForm] string orgphotoname,
            ...
            [FromForm] string description, string createdby)
        {
            ...
            LifeCoachesResponse objppfr = new LifeCoachesResponse();
            LifeCoachesParam objppfp = new LifeCoachesParam();
            ...
            objppfp.coachtype = Convert.ToInt32(coachtype);
            objppfp.agendatype = Convert.ToInt32(agendatype);
            objppfp.topic = Convert.ToString(topic);
            ...
            try
            {
                ...
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("savelifecoachesdata_new", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("message", "");
                cmd.Parameters["message"].Direction = ParameterDirection.Output;
                cmd.Parameters.AddWithValue("interviewid_d", objppfp.interviewid);
                cmd.Parameters.AddWithValue("coachtype_d", objppfp.coachtype);
                cmd.Parameters.AddWithValue("agendatype_d", objppfp.agendatype);
                cmd.Parameters.AddWithValue("topic_d", objppfp.topic);
                ...
                try
                {
                    if (careerlist.Length > 0)
                    {
                        ...
                        qry = "SELECT MAX(interviewid) as int_id FROM tbl_lifecoachesinformation";
        ...
        public string BindInterviewData()
        {
            string json = "";
            DataSet ds = new DataSet();
            GetLifecoachesDataResponse ObjGSPDR = new GetLifecoachesDataResponse();
            List<GetlifecoachesData> ListGSPD = new List<GetlifecoachesData>();

            try
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("Getlifecoachdata_new", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        GetlifecoachesData ObjGSPD = new GetlifecoachesData();
                        ...
                        ObjGSPD.agendatype = Convert.ToString(row["agendatype"]);
                        ObjGSPD.topic = Convert.ToString(row["topic"]);
        ...
        [HttpGet]
        [Route("GetEditData")]
        public string GetEditedData([FromHeader] Geteditrecords obj)
        {
            string json = "";
            DataSet ds = new DataSet();
            GetEditcoachResponses ObjGER = new GetEditcoachResponses();
            try
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("editcoach_new", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    GetEditcoachData ObjGED = new GetEditcoachData();
                    ...
                    ObjGED.agendatype = Convert.ToInt32(ds.Tables[0].Rows[0]["agendatype"]);
                    ObjGED.topic = Convert.ToString(ds.Tables[0].Rows[0]["topic"]);
        ...
        public async Task<IActionResult> Updatelifecoachesdata([FromForm] IFormFile photo, [FromForm] string coachtype, [FromForm] string agendatype, [FromForm] string topic,
       ...
       [FromForm] string description, [FromForm] string createdby, [FromForm] string interviewid)

        {
            ...
            try
            {
                ...
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("updateplifecoachesdata_new", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("message", "");
                cmd.Parameters["message"].Direction = ParameterDirection.Output;
                cmd.Parameters.AddWithValue("interviewid_d", objppfp.interviewid);
        ...
        public string DeleteActivities([FromBody] InterviewLifecoachesParamdata obj)
        {
            string json = "";
            string result = "";
            DataSet ds = new DataSet();
            PersonalLifecoachesResponses ObjAMR = new PersonalLifecoachesResponses();
            try
            {
                MySqlConnection con = new SoftwareConnection(_iconfiguration).GetConnection();
                MySqlCommand cmd = new MySqlCommand("Deletecoach_new", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("message", "");
                cmd.Parameters["message"].Direction = ParameterDirection.Output;
    ...
    public class PersonalLifecoachesResponses
    {
        public bool Status { get; set; }
        public string Message { get; set; }
    }

    public class InterviewLifecoachesParamdata
    {
    ...
    public class GetLifecoachesDataResponse
    {
        public bool Status { get; set; }
        public string Message { get; set; }

        public List<GetlifecoachesData> data { get; set; }

    }
    public class GetlifecoachesData
    {
        public Int32 interviewid { get; set; }
    ...
    //edit class
    public class Geteditrecords
    {

        public Int32 interviewid { get; set; }

    }
    public class GetEditcoachResponses
    {
        public bool Status { get; set; }
        public string Message { get; set; }
        public GetEditcoachData data { get; set; }
    }
    public class GetEditcoachData
    {
        public Int32 interviewid { get; set; }
        public Int32 coachtype { get; set; }
        public Int32 agendatype { get; set; }
        public string topic { get; set; }
    ...
    public class LifeCoachesResponse
    {
        public bool Status { get; set; }
        public string Message { get; set; }

    }
    public class LifeCoachesParam
    {
